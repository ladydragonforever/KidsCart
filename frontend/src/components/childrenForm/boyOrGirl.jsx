                ...
                <div className="children-form-inner">
                    ...
                    <div className="gender-container">
                        <div className={this.state.girl} onClick={this.changeGirlClass}>
                            <img alt='' src="https://i.ya-webdesign.com/images/icons-transparent-baby-6.png" style={{ width: "20vw" }}/>
                        </div>
                        <div className={this.state.boy} onClick={this.changeBoyClass}>
                            <img alt='' src="https://image.flaticon.com/icons/png/512/30/30048.png" style={{ width: "20vw" }} />
                        </div>
                    </div>
